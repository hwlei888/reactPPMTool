...
class AddProjectTask extends Component {
    ...
    //then we have new props that we need to receive
    //and those are called nextProps
...
const AddProjectTaskWrapper = (props) => {
    ...
    return <AddProjectTask {...props} id={id} navigate={ navigate } />;
};

AddProjectTaskWrapper.propTypes = {
